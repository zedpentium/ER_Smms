...
namespace ER_Smms.Models.ViewModels.Frontend
{
    ...
    public class ApplicantCreateAccountViewModel : DateCreatedEdited
    {
        // Convert from object to viewmodel on-the-fly in 1 place
        public static implicit operator ApplicantCreateAccountViewModel(Applicant obj)
        {
            return new ApplicantCreateAccountViewModel
            {
                Id = obj.Id,
        ...
        public static implicit operator Applicant(ApplicantCreateAccountViewModel viewModel)
        {
