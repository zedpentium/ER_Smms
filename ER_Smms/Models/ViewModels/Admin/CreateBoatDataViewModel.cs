...
namespace ER_Smms.Models.ViewModels.Admin
{
    ...
    public class CreateBoatDataViewModel : DateCreatedEdited
    {
        // Convert from object to viewmodel on-the-fly in 1 place
        public static implicit operator CreateBoatDataViewModel(BoatData obj)
        {
            return new CreateBoatDataViewModel
            {
                Id = obj.Id,
                Label = obj.Label,
        ...
        public static implicit operator BoatData(CreateBoatDataViewModel viewModel)
        {
            return new BoatData
            {
