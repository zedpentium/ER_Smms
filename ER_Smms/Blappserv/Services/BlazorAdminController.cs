...
{
    public class BlazorAdminController
    {
        ...
        public async Task<BEditBoatslipViewModel> EditBoatslipAsync(int id)
        {
            BEditBoatslipViewModel editViewModel = await _boatslipService.FindBy(id);
        ...
        public async Task EditBoatslipSave(BEditBoatslipViewModel editViewModel)
        {
            ...
            //await JSRuntime.InvokeVoidAsync("setAndShowToast", "success", "Spara BåtplatsEditering", "Ändringar Sparade.", 7000);

            _navManager.NavigateTo("/admin/blappserv");
        }
